...
function agregarSimboloExclamacion(str) {
  ...
  // Tu código:
  var signoDeAdmiracion = "!";
  var textoCompleto = str + signoDeAdmiracion;
...
function combinarNombres(nombre, apellido) {
  ...
  // Tu código:
  var textoCompleto = nombre + " " + apellido;
  return textoCompleto;
...
function obtenerSaludo(nombre) {
  ...
  var mensaje = "Hola ";
  var signoDeAdmiracion = "!"
  var textoCompleto = mensaje + nombre + signoDeAdmiracion;
  return textoCompleto;
